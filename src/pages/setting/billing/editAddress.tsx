...
const EditAddress = ({ children }: { children: ReactNode }) => {
  ...
  const onSubmit = async (addressEdited: AddressType) => {
    try {
      editAddress(addressEdited, address?.id);
...
EditAddress.getLayout = function getLayout(page: React.ReactElement) {
